...
namespace Mgid\KafkaBundle\Command;

use Exception;
use JsonException;
use Mgid\KafkaBundle\DependencyInjection\Traits\{ConsumerTrait, LoggerTrait};
use RdKafka\Message;
...
abstract class Consumer extends Console\Command\Command
{
    ...
    final protected function configure(): void
    {
        $this->addOption(
            ...
            'Consuming timeout',
            \Mgid\KafkaBundle\Consumer\Consumer::DEFAULT_TIMEOUT
        );
    }
